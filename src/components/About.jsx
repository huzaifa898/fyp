    ...
    <div className="font-roboto bg-gray-100 text-gray-800">
      ...
      <section className="bg-gray-900 text-white py-16 px-8">
        <div className="container mx-auto">
          <h1 className="text-4xl font-bold mt-8 mb-12 text-center font-montserrat">
            <span className="bg-gradient-to-r from-teal-600 to-teal-500 text-transparent bg-clip-text">About Us</span>
          </h1>
          ...
          >
            <h2 className="text-3xl font-semibold mb-4 text-center font-montserrat">
              <span className="bg-gradient-to-r from-teal-600 to-teal-500 text-transparent bg-clip-text">Our Journey</span>
            </h2>
            <div className="timeline-content space-y-8">
              <div className="timeline-item border-l-4 pl-6 pb-4 border-teal-500">
                <h3 className="text-2xl font-semibold text-teal-500 font-montserrat">2020 - Founded</h3>
                <p className="text-lg font-palanquin">Our platform was founded with the vision to connect entrepreneurs and investors globally.</p>
              </div>
              <div className="timeline-item border-l-4 pl-6 pb-4 border-teal-500">
                <h3 className="text-2xl font-semibold text-teal-500 font-montserrat">2021 - First Milestone</h3>
                <p className="text-lg font-palanquin">Reached 10,000 registered users and secured our first major investment round.</p>
              </div>
              <div className="timeline-item border-l-4 pl-6 pb-4 border-teal-500">
                <h3 className="text-2xl font-semibold text-teal-500 font-montserrat">2022 - Global Expansion</h3>
                <p className="text-lg font-palanquin">Expanded our services to multiple countries, helping entrepreneurs worldwide.</p>
              </div>
            </div>
          </motion.div>
            ...
            <motion.div 
              className="founder-message mt-16 p-8 bg-gradient-to-r from-teal-400 to-teal-500 text-white rounded-lg shadow-lg"
              initial="offscreen"
              whileInView="onscreen"
              viewport={{ once: true, amount: 0.5 }}
              variants={founderVariants}
            >
              <h2 className="text-3xl font-semibold mb-4 text-center font-montserrat">A Message from Our Founder</h2>
              <p className="text-lg mb-4 font-palanquin">
              ...
              <p className="mt-4 text-right text-xl font-bold font-montserrat">- [Founder's Name]</p>
            </motion.div>
            ...
            >
              <h2 className="text-3xl font-semibold mb-4 text-center font-montserrat">
                <span className="bg-gradient-to-r from-teal-400 to-teal-500 text-transparent bg-clip-text">Introduction Video</span>
              </h2>
            ...
            >
              <h2 className="text-3xl font-semibold mb-4 text-center font-montserrat">
                <span className="bg-gradient-to-r from-teal-400 to-teal-500 text-transparent bg-clip-text">What Our Users Say</span>
              </h2>
              <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                {testimonials.map((testimonial, index) => (
                  ...
                  >
                    ...
                    <h3 className="text-xl mt-4 text-white font-bold font-montserrat">{testimonial.name}</h3>
                  </motion.div>
                ))}
              </div>
            </motion.div>
