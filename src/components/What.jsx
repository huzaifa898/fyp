    ...
    <section className="py-20">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div
            className="bg-white-600 shadow-md rounded-lg p-8 hover:bg-black transition duration-300 ease-in-out"
            onMouseOver={(e) => {
          ...
          <div
            className="bg-white shadow-md rounded-lg p-8 hover:bg-black transition duration-300 ease-in-out"
            onMouseOver={(e) => {
              e.target.style.color = "white";
            }}
            onMouseOut={(e) => {
