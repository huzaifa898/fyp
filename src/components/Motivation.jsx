  ...
  return (
    <section className="py-16 bg-blue-100">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-6 font-abc">Invest in Tomorrow' <span className='text-secondary font-cursive'>Innovators Today</span> </h2>
        <p className="text-lg text-gray-600 text-center font-abc mb-12">Lovely people with a knack for design creativity flourish here.</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col items-center justify-center">
            <p className="text-lg text-black font-abc text-justify">
